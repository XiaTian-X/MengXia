...
fn rust_message_kind(full_name: &str) -> &'static str {
    match full_name {
        ...
        "mengxia.core.v1.GetLibraryStatusRequest" => "GetLibraryStatusRequest",
        "mengxia.core.v1.VerifyLibraryRequest" => "VerifyLibraryRequest",
        "mengxia.core.v1.ListIntegrityIssuesRequest" => "ListIntegrityIssuesRequest",
        "mengxia.core.v1.InspectAssetRequest" => "InspectAssetRequest",
        "mengxia.core.v1.ListAssetsRequest" => "ListAssetsRequest",
        "mengxia.core.v1.MaterializeAssetRequest" => "MaterializeAssetRequest",
        "mengxia.core.v1.AssetRevisionMemberInput" => "AssetRevisionMemberInput",
        "mengxia.core.v1.AssetRevisionResourceInput" => "AssetRevisionResourceInput",
        "mengxia.core.v1.AssetRevisionRepresentationInput" => "AssetRevisionRepresentationInput",
        "mengxia.core.v1.ProjectSpecInput" => "ProjectSpecInput",
        "mengxia.core.v1.CreateAssetRevisionRequest" => "CreateAssetRevisionRequest",
        "mengxia.core.v1.AssetLifecycleRequest" => "AssetLifecycleRequest",
        "mengxia.core.v1.CreateProjectRequest" => "CreateProjectRequest",
        "mengxia.core.v1.ReviseProjectSpecRequest" => "ReviseProjectSpecRequest",
        "mengxia.core.v1.ListProjectsRequest" => "ListProjectsRequest",
        "mengxia.core.v1.CreateSubjectRequest" => "CreateSubjectRequest",
        "mengxia.core.v1.ListSubjectsRequest" => "ListSubjectsRequest",
        "mengxia.core.v1.CreateWorkItemRequest" => "CreateWorkItemRequest",
        "mengxia.core.v1.ReviseWorkRequest" => "ReviseWorkRequest",
        "mengxia.core.v1.ListWorkRequest" => "ListWorkRequest",
        "mengxia.core.v1.CreateTakeRequest" => "CreateTakeRequest",
        "mengxia.core.v1.TransitionTakeRequest" => "TransitionTakeRequest",
        "mengxia.core.v1.ReopenTakeRequest" => "ReopenTakeRequest",
        "mengxia.core.v1.ListTakesRequest" => "ListTakesRequest",
        "mengxia.core.v1.GetLibraryStatusResult" => "GetLibraryStatusResult",
        "mengxia.core.v1.VerifyLibraryResult" => "VerifyLibraryResult",
        "mengxia.core.v1.IntegrityIssue" => "IntegrityIssue",
        "mengxia.core.v1.ListIntegrityIssuesResult" => "ListIntegrityIssuesResult",
        "mengxia.core.v1.AssetSummary" => "AssetSummary",
        "mengxia.core.v1.ListAssetsResult" => "ListAssetsResult",
        "mengxia.core.v1.AssetMemberView" => "AssetMemberView",
        "mengxia.core.v1.InspectAssetResult" => "InspectAssetResult",
        "mengxia.core.v1.MaterializeAssetResult" => "MaterializeAssetResult",
        "mengxia.core.v1.CreateAssetRevisionResult" => "CreateAssetRevisionResult",
        "mengxia.core.v1.AssetLifecycleMutationResult" => "AssetLifecycleMutationResult",
        "mengxia.core.v1.ProjectMutationResult" => "ProjectMutationResult",
        "mengxia.core.v1.SubjectMutationResult" => "SubjectMutationResult",
        "mengxia.core.v1.WorkMutationResult" => "WorkMutationResult",
        "mengxia.core.v1.TakeMutationResult" => "TakeMutationResult",
        "mengxia.core.v1.ProjectSpecView" => "ProjectSpecView",
        "mengxia.core.v1.ProjectView" => "ProjectView",
        "mengxia.core.v1.ListProjectsResult" => "ListProjectsResult",
        "mengxia.core.v1.SubjectView" => "SubjectView",
        "mengxia.core.v1.ListSubjectsResult" => "ListSubjectsResult",
        "mengxia.core.v1.WorkView" => "WorkView",
        "mengxia.core.v1.ListWorkResult" => "ListWorkResult",
        "mengxia.core.v1.TakeRelationshipView" => "TakeRelationshipView",
        "mengxia.core.v1.TakeView" => "TakeView",
        "mengxia.core.v1.ListTakesResult" => "ListTakesResult",
