...
| TASK-007 copy-only ingest gate 已接受，production implementation 尚未完成 | proposal v0.1.3; ADR-0009; Specification v1.1.24; Plan start record | `DECISION / IN_PROGRESS` | authority `TASK_007_ONLY`; migration、root rebind、Admin、TASK-008+ 禁止 |
...
the exact TASK-006 candidate and retained gates. TASK-007 proposal v0.1.3, ADR-0009
