...
the exact TASK-006 candidate and retained gates. Current implementation authority is
`NONE`. The first safe next action is a separate TASK-007 start-gate review and
canonical activation; implementation must not begin before that gate is accepted.
